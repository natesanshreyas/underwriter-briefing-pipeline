"""
AI Foundry Agent Backend - FastAPI Server
...
OPENAI_ENDPOINT = os.getenv("OPENAI_ENDPOINT", "https://invalid-junk-endpoint.services.ai.azure.com/")
...
def get_openai_client():
    ...
    if not OPENAI_ENDPOINT:
        raise HTTPException(
            status_code=500,
            detail="OpenAI endpoint not configured. Set OPENAI_ENDPOINT"
        )
