...
# 2. Creates ACA environment if needed
# 3. Deploys agent to ACA Container Apps (24/7 running)
# 4. Deploys batch job to ACA Jobs (scheduled cron)
#
...
docker build -f Dockerfile.batch -t "$BATCH_IMAGE" .
docker push "$BATCH_IMAGE"
echo "  ✅ Batch image pushed"

# Step 3: Create ACA environment if it doesn't exist
echo ""
...
# Step 5: Deploy agent (Container App)
echo ""
...
# Step 6: Deploy batch job (ACA Job)
echo ""
